...
восстановления реплики.](./README.md#Задача-Долгосрочная-изоляция)
3. [Сбои сервисов зависимостей: Изучить поведение кластера Patroni при сбоях в сопутствующих сервисах, например, etcd (которые используются для хранения состояния кластера), путем имитации его недоступности или некорректной работы.](./README.md#Задача-Сбои-сервисов-зависимостей)
